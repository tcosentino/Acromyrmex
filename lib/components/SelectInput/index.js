...
var SelectInput = function (_React$Component) {
  ...
  _createClass(SelectInput, [{
    ...
    value: function render() {
      ...
      var selectInput = loading ? _react2.default.createElement(_acromyrmex.Loading, null) : _react2.default.createElement(_TetheredSelectWrapper2.default, _extends({}, inputProps, {
        name: input.name,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ConfirmModal2.default, {
          ...
          onConfirm: function onConfirm() {
            _this2.handleChange(_this2.state.pendingVal);
