  ...
  _createClass(SelectInput, [{
    ...
    value: function componentDidUpdate() {
      ...
      var _props = this.props,
          enableEmpty = _props.enableEmpty,
          multi = _props.multi;
    ...
    value: function getOptions() {
      var _props2 = this.props,
          ...
          enableAll = _props2.enableAll,
          templateOptions = _props2.templateOptions;
    ...
    value: function sendChange(value) {
      var _props5 = this.props,
          onChangeAction = _props5.onChangeAction,
          input = _props5.input;
    ...
    value: function render() {
      ...
      var _props6 = this.props,
          ...
          enableEmpty = _props6.enableEmpty,
          addon = _props6.addon,
          multi = _props6.multi,
          meta = _props6.meta,
          noLabel = _props6.noLabel,
          disabled = _props6.disabled,
          vertical = _props6.vertical,
          optionRenderer = _props6.optionRenderer,
          valueRenderer = _props6.valueRenderer,
          input = _props6.input,
          inputProps = _objectWithoutProperties(_props6.input, []),
          confirm = _props6.confirm,
          confirmMessage = _props6.confirmMessage,
          maxCols = _props6.maxCols,
          addonAfter = _props6.addonAfter,
          addonBefore = _props6.addonBefore,
          addonCustomBefore = _props6.addonCustomBefore,
          addonCustomAfter = _props6.addonCustomAfter;

      var _state = this.state,
          showModal = _state.showModal,
          pendingVal = _state.pendingVal;
      ...
      var selectInput = loading ? _react2.default.createElement(_Loading2.default, null) : _react2.default.createElement(_TetheredSelectWrapper2.default, _extends({}, inputProps, {
        ...
        onChange: function onChange(val) {
          if (confirm) {
            _this2.setState({ showModal: true, pendingVal: val });
          } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ConfirmModal2.default, {
          ...
          onConfirm: function onConfirm() {
            ...
            _this2.setState({ showModal: false, pendingVal: null });
          },
