...
var TetheredSelectWrap = function (_Select) {
  _inherits(TetheredSelectWrap, _Select);

  function TetheredSelectWrap(props) {
    _classCallCheck(this, TetheredSelectWrap);

    var _this = _possibleConstructorReturn(this, (TetheredSelectWrap.__proto__ || Object.getPrototypeOf(TetheredSelectWrap)).call(this, props));
  ...
  _createClass(TetheredSelectWrap, [{
    ...
    value: function _renderOuter() {
      ...
      var menu = _get(TetheredSelectWrap.prototype.__proto__ || Object.getPrototypeOf(TetheredSelectWrap.prototype), 'renderOuter', this).apply(this, rest);
