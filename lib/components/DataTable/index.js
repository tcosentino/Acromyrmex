...
var DataGrid = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DataGrid, null, [{
    ...
    value: function _formatDateWithString(date, string) {
      ...
      if (typeof toParse === 'number') {
        tryFormat = // hacky way to check if millisecond timestamp or seconds
    ...
    value: function formatValue(value, type) {
      switch (type) {
        ...
        case 'array':
          return _react["default"].createElement("ul", null, value.map(function (item) {
  ...
  function DataGrid(props) {
    ...
    var measureOptions = props.measureAll ? {
      ...
      fixedWidth: true,
      defaultHeight: 45 // minHeight: browser.lessThan.small ? 40 : 50,
    ...
    _this.onFilterChanged = _this.onFilterChanged.bind(_assertThisInitialized(_this)); // throttle filter changing
  ...
  _createClass(DataGrid, [{
    ...
    value: function _refreshGridSize() {
      ...
      this.mainGrid.measureAllCells(); // this.mainGrid.invalidateCellSizeAfterRender();
    ...
    value: function onFilterChanged(filterObj) {
      ...
      var newFilters = _objectSpread({}, this.state.filters, _defineProperty({}, filterObj.key, filterObj));
    ...
    value: function getRows() {
      ...
      var _this$props = this.props,
          ...
          paged = _this$props.paged; // get the name of each column into an array
      ...
      var sorted = paged ? filtered : this._sortRows(filtered); // put the header as column one, and the rest after
    ...
    value: function renderMultiGrid(_ref3) {
      ...
      console.log(rowCount); // if (rowCount < 2) {
      //   return DataGrid.emptyRenderer();
      // }

      return _react["default"].createElement(_MultiGrid["default"], {
    ...
    value: function _onSortChanged(column) {
      ...
      var _this$state2 = this.state,
          ...
          sortDirection = _this$state2.sortDirection; // discard non-sortable columns
    ...
    value: function renderCell(_ref4) {
      ...
      var cellStyles = _objectSpread({}, style, {
      ...
      }, rowIsHeader && sortBy === column.key && _react["default"].createElement("span", {
      ...
      }, rowIsHeader ? data[column.key] : DataGrid.formatData(column, data)), rowIsHeader && column.filterable && _react["default"].createElement("input", {
        type: "text",
      ...
      }), rowIsHeader && column.filterable && _react["default"].createElement("a", {
    ...
    value: function render() {
      ...
      var rowCount = this.getRowCount();
      var colCount = this.getColumnCount(); // const rows = this.getRows();
      ...
      return _react["default"].createElement("div", {
      ...
      }, _react["default"].createElement(_AutoSizer["default"], _extends({}, this.props.gridProps, {
        ...
        filter: filter
      }), this.renderMultiGrid)), paged && this._renderFooter(), _react["default"].createElement("div", {
    ...
    value: function _renderFooter() {
      ...
      }, _react["default"].createElement("em", null, "Showing ", (currentPage - 1) * pageSize + 1, " - ", showing, " of ", totalItemCount)), _react["default"].createElement(_Pagination["default"], {
        bsSize: "sm",
