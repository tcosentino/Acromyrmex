  ...
  _createClass(DateInput, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          extraProps = _objectWithoutProperties(_props, ['help', 'label', 'prefix', 'noLabel', 'vertical', 'autoFocus', 'addonAfter', 'addonBefore', 'addonCustomBefore', 'addonCustomAfter', 'input', 'meta', 'disabled', 'dateFormat', 'timeFormat', 'dateTimeFormat', 'options', 'maxCols', 'showTimeSelect', 'showDateSelect', 'getCalendarContainer']);

      var _state = this.state,
          open = _state.open,
          optionSelected = _state.optionSelected;
