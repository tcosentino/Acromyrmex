...
var OurEditor = function (_React$Component) {
  ...
  _createClass(OurEditor, [{
    ...
    value: function getStateFromMarkdown(value) {
      ...
      return _draftJs.EditorState.createWithContent(plainText ? (0, _stateFromPlainText2.default)(value, this.state.suggestions, this.mentionStateFromMarkdownFunctions) : (0, _stateFromMarkdown2.default)(value, this.state.suggestions, this.mentionStateFromMarkdownFunctions), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])]));
    }
  }, {
