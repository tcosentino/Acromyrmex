...
var OurEditor = function (_React$Component) {
  ...
  function OurEditor(props) {
    ...
    _this.state = {
      // Editor state is
      editorState: props && props.input && props.input.value && props.input.value.length ? _draftJs.EditorState.createWithContent((0, _stateFromMarkdown2.default)(props.input.value), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])])) : _draftJs.EditorState.createEmpty(),
