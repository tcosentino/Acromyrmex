...
var OurEditor = function (_React$Component) {
  ...
  function OurEditor(props) {
    ...
    _this.state = {
      // Editor state is
      editorState: props && props.input && props.input.value && props.input.value.length ? _draftJs.EditorState.createWithContent((0, _stateFromMarkdown2.default)(props.input.value, OurEditor.fixOptions(props.options)), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])])) : _draftJs.EditorState.createEmpty(),
  ...
  _createClass(OurEditor, [{
    ...
    value: function componentWillMount() {
      ...
      this.setState({ suggestions: OurEditor.fixOptions(options) }, function () {
        if (hasValue) {
          _this2.onChange(_draftJs.EditorState.push(_this2.state.editorState, _draftJs.EditorState.createWithContent((0, _stateFromMarkdown2.default)(input.value, OurEditor.fixOptions(options)), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])])).getCurrentContent()));
        }
      });
    }
  }, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.options.length !== nextProps.options.length) {
        this.setState({ suggestions: OurEditor.fixOptions(nextProps.options) }, function () {
          if (hasValue) {
            _this3.onChange(_draftJs.EditorState.push(_this3.state.editorState, _draftJs.EditorState.createWithContent((0, _stateFromMarkdown2.default)(input.value, OurEditor.fixOptions(nextProps.options)), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])])).getCurrentContent()));
          }
        });
      }
    }
    ...
    value: function componentDidUpdate() {
      ...
      if (md !== this.props.input.value) {
        this.onChange(_draftJs.EditorState.push(this.state.editorState, _draftJs.EditorState.createWithContent((0, _stateFromMarkdown2.default)(this.props.input.value, OurEditor.fixOptions(this.props.options)), new _MultiDecorator2.default([new _draftJs.CompositeDecorator([_LinkDecorator2.default])])).getCurrentContent()));
      }
    }
    ...
    value: function onSearchChange(_ref) {
      ...
      this.setState({
        suggestions: (0, _suggestionsFilter2.default)(value, OurEditor.fixOptions(this.props.options))
      });
    }
  }, {
